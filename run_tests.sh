...
"${script_dir}"/tests/harness.sh --test "${script_dir}"/tests/cpu_apple_module.sh --expected "${script_dir}"/tests/cpu_apple_module_expected.txt "$@"
...
"${script_dir}"/tests/harness.sh --test "${script_dir}"/tests/ram_apple_module.sh --expected "${script_dir}"/tests/ram_apple_module_expected.txt "$@"
"${script_dir}"/tests/harness.sh --test "${script_dir}"/tests/gpu_module.sh --expected "${script_dir}"/tests/gpu_module_expected.txt "$@"
"${script_dir}"/tests/harness.sh --test "${script_dir}"/tests/gpu_apple_module.sh --expected "${script_dir}"/tests/gpu_apple_module_expected.txt "$@"
